...
public class PayrollSystemTest {
	public static void main(String[] args)
	{
		...
		CommissionEmployee commissionEmployee = new CommissionEmployee("Sue","Jones","333-33-3333",10000,.02);
		BasePlusCommissionEmployee basePlusCommissionEmployee = new BasePlusCommissionEmployee("Bob","Lewis","444-44-4444",5000,.04,300);
		PieceWorker pieceWorker = new PieceWorker("Dave","Brown","555-55-5555",2.25,400);
